...
class DeeproboticsLite3StairEnvCfg(DeeproboticsLite3RoughEnvCfg):
    def __post_init__(self):
        ...
        self.scene.terrain.terrain_generator.sub_terrains["pyramid_stairs"].proportion = 0.65 # c''etait a 50 avant 
        ...
        self.rewards.ang_vel_xy_l2.weight = -0.045           # corps peut s'incliner
        ...
        self.rewards.feet_air_time_variance.weight = -0.02
           # rythme libre
        self.rewards.base_height_l2.weight = -15.0 # j'ai changer egalement ses deux -10 
        ...
        self.commands.base_velocity.ranges.lin_vel_x = (0.0, 0.55) ## il etais a 7 

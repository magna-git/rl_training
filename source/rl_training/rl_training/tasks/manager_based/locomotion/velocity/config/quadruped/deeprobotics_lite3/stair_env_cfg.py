...
class DeeproboticsLite3StairEnvCfg(DeeproboticsLite3RoughEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.feet_air_time.params["threshold"] = 0.55 ## c'est le temps  qu'il faut pour qu'une pattes raméne ses pattes
        self.rewards.feet_gait.weight = 1.5                  # forcer trot diagonal
        self.rewards.joint_mirror.weight = -0.09            # symétrie souple
        ...
        self.commands.base_velocity.ranges.lin_vel_x = (0.0, 0.70)

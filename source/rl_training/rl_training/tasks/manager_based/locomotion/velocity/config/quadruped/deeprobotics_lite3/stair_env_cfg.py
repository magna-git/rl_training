...
class DeeproboticsLite3StairEnvCfg(DeeproboticsLite3RoughEnvCfg):
    def __post_init__(self):
        ...
        self.rewards.ang_vel_xy_l2.weight = -0.1           # corps peut s'incliner
        self.rewards.flat_orientation_l2.weight = -2.0     # dos peut s'incliner
        self.rewards.feet_height.params["target_height"] = 0.16  # marches de 15.5cm
        self.rewards.feet_air_time.params["threshold"] = 0.62 ## c'est le temps  qu'il faut pour qu'une pattes raméne ses pattes
        self.rewards.feet_gait.weight = 1.5                  # forcer trot diagonal
        self.rewards.joint_mirror.weight = -0.07            # symétrie souple
        self.rewards.feet_air_time_variance.weight = -4.0   # rythme libre
